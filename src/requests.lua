-- Couldn't install it via luarocks, because it depends on xml module, which is not compatibale with lua 5.4+
-- Fix applied based on https://github.com/JakobGreen/lua-requests/issues/32
-- https://github.com/JakobGreen/lua-requests/blob/master/src/requests.lua
